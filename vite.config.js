...
const SAVE_ALLOWED_FILES = ['ArmyTable.xlsx', 'StageStepTable.xlsx', 'StageTable.xlsx', 'ItemTable.xlsx', 'LuckyDrawTable.xlsx', 'FunctionUnlockTable.xlsx', 'names.xlsx', 'name.xlsx']
